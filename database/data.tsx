const data: Record<any, any> = {
    '2zd33b8c': {
      ...
      sku: 'NUR72KCM',
      price: 1.15,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/maluma.jpg',
      attributes: {
        description:
    ...
    '6trfgkkj': {
      ...
      sku: 'AX4M8SJV',
      price: 1.21,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/fuerte.jpg',
      attributes: {
        description:
    ...
    '7bcr49em': {
      ...
      sku: 'HYA78F6J',
      price: 1.25,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/gwen.jpg',
      attributes: {
        description:
    ...
    '098323ks': {
      ...
      sku: 'BXD100BLK',
      price: 1.51,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/bacon.jpg',
      attributes: {
        description:
    ...
    b8uthe2y: {
      ...
      sku: 'RMRCZN7E',
      price: 1.39,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/hass.jpg',
      attributes: {
        description:
    ...
    ewxsd6xb: {
      ...
      sku: 'N55229ZA',
      price: 1.34,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/lamb.jpg',
      attributes: {
        description:
    ...
    fpr72m9k: {
      ...
      sku: 'B4HZ42TM',
      price: 1.27,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/pinkerton.jpg',
      attributes: {
        description:
    ...
    t9dv25gs: {
      ...
      sku: 'ZY3T9XXC',
      price: 1.18,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/reed.jpg',
      attributes: {
        description:
    ...
    t345w48y: {
      ...
      sku: 'MW79ZZ6Y',
      price: 1.25,
      image: 'https://erickperez.dev/wp-content/uploads/2022/03/zutano.jpg',
      attributes: {
        description:
